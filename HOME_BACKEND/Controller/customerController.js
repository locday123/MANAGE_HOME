...
const handleImageUpload = (
    ...
    if (oldImagePath) {
        ...
        ); // Tạo đường dẫn đầy đủ cho ảnh cũ
...
const createCustomer = async (req, res) => {
    try {
        ...
        const newCustomer = new Customer({
            ...
            customer_Date,
            customer_Status,
            customer_Front: frontImage,
            customer_Back: backImage,
        });
...
const deleteCustomer = async (req, res) => {
    ...
    try {
        ...
        if (
            frontImagePath &&
            fs.existsSync(path.join(__dirname, frontImagePath))
        ) {
            fs.unlinkSync(path.join(__dirname, frontImagePath)); // Xóa ảnh mặt trước
        }
        if (
            backImagePath &&
            fs.existsSync(path.join(__dirname, backImagePath))
        ) {
...
const updateCustomer = async (req, res) => {
    ...
    try {
        ...
        const data = {
            ...
            customer_Status:
                req.body.customer_Status === "ACTIVE" ||
                req.body.customer_Status === true
                    ? "ACTIVE"
                    : "INACTIVE",
        };
